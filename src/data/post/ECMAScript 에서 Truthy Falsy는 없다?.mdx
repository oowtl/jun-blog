---
title: 'ECMAScript 에서 Truthy 와 Falsy는 없다?'
summary: 'Truthy 와 Falsy 는 학습을 위해서, 설명하기 위해서 만들어진 단어입니다. (MDN 문서에서 Truthy 와 Falsy 라는 단어를 학습할 수 있습니다.)'
tags: ['javascript']
createdAt: '2024.02.04 17:54'
---
